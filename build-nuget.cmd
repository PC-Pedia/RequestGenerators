@ECHO OFF
setlocal
if "%PROJECTNAME%" == "" set PROJECTNAME=RequestGenerators
...
echo %NUGET_EXE% pack %PROJECTNAME%.nuspec -version %BUILD_VERSION%
%NUGET_EXE% pack %PROJECTNAME%.nuspec -version %BUILD_VERSION%
popd
popd
